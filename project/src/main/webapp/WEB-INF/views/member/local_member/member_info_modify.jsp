...
<div  style="background-color:rgb(244, 244, 247); height:1000px;">
    <div class="user-info-modify-card-frame" style="position: absolute; top: 55%; left: 50%; transform: translate(-50%, -50%); background-color: white; width: 50%; height: 50%; padding: 20px;">
		<div class="form-tag-for-modify-info" style="position: absolute; top: 50%; left:50%; transform:translate(-50%, -50%); width:85%; height:85%;">
			
			<form action="/localModifyInfoDo" method="post" style="position:absolute; top: 55%; left:50%; transform:translate(-50%, -50%); width:80%; height:80%;">
				...
				<div align="center" style="font-size:15px; margin-bottom:25px;">
					------- 아래는 변경을 원할 경우에만 작성해주세요. -------
				</div>
				<div align="center" style="margin-bottom:35px;">
					<table>
						<tr>
							<th style="height:50px;">비밀번호</th>
							<td><input style="height:20px;" type="password" name="userPw" ></td>
						</tr>
						<tr>
							<th>비밀번호 확인</th>
							<td><input style="height:20px;" type="password" name="pwCheck"></td>
						</tr>
					</table>
				</div>
				<div align="center">
