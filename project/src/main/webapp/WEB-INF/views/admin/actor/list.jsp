	...
	<div align="center" class="list-page">
		<div align="center" class="list-page-div">
			...
			<div class="auto-table-menu-header">
				<a class="auto-table-menu" href="/admin/${ autoPaging.listNm }/${ autoPaging.tableNm }/people_id/1?query="><div class="auto-table-menu-div">ID</div></a>
				<a class="auto-table-menu" href="/admin/${ autoPaging.listNm }/${ autoPaging.tableNm }/people_nm/1?query="><div class="auto-table-menu-div">이름</div></a>
