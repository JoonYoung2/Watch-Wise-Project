...
public class MemberAjaxController {
	...
	public MsgOnlyResponse reportComment(@RequestParam("author") String authorEmail, @RequestParam("comment") String comment, 
										@RequestParam("commentId") String commentId, @RequestParam("movieId") String movieId,
										@RequestParam("reason") String reason, RedirectAttributes redirectAttr) {
