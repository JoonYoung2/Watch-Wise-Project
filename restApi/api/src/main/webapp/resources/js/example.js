	...
	const dailyList = async () => {
		let dailyMovieNms = "";
		await fetch("http://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=f5eef3421c602c6cb7ea224104795888&targetDt=20231011",
		        {
		            method: "get"
		        })
		        .then(res => res.json())
